...
<body class="bg-lightgray py-10 min-h-screen">
    ...
    <div class="max-w-xl mx-auto bg-white shadow-lg rounded-lg p-8 border-2 border-upmaroon">
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-red md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-red-600">Link Shortener</span></h1>
